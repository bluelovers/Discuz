 ...
 *
 *      $Id: table_forum_forum_threadtable.php 27449 2012-02-01 05:32:35Z zhangguosheng $
 */
...
class table_forum_forum_threadtable extends discuz_table
{
	...
	public function delete($fid, $threadtableid, $unbuffered = false) {
		return DB::delete($this->_table, array('fid' => $fid, 'threadtableid' => $threadtableid), null, $unbuffered);
	}
