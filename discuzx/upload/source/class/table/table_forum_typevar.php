 ...
 *
 *      $Id: table_forum_typevar.php 27449 2012-02-01 05:32:35Z zhangguosheng $
 */
...
class table_forum_typevar extends discuz_table
{
	...
	public function fetch_all_by_sortid($sortid, $order = '') {
		return DB::fetch_all('SELECT * FROM %t WHERE sortid=%d '.($order ? 'ORDER BY displayorder '.$order : ''), array($this->_table, $sortid), 'optionid');
	}
