...
$Test->setFontProperties('./source/plugin/stock_dzx/font/tahoma.ttf',8);
...
$Test->setFontProperties('./source/plugin/stock_dzx/font/tahoma.ttf',8);//如果不设置，则要查询，速度会变慢
$Test->drawTitle(50,22,"Stock Price of Recent Hours",50,50,50,500);
$Test->Render("./source/plugin/stock_dzx/data/k_{$stock_id}.png");
?>
