 ...
 *
 *      $Id: viewthread.php 27451 2012-02-01 05:48:47Z monkey $
 */
...
class mobile_api {
	...
	function output() {
		...
		$variable = array(
			...
			'fid' => $_G['fid'],
			'postlist' => array_values(mobile_core::getvalues($GLOBALS['postlist'], array('/^\d+$/'), array('pid', 'tid', 'author', 'first', 'dbdateline', 'dateline', 'useip', 'username', 'adminid', 'email', 'memberstatus', 'authorid', 'username', 'groupid', 'memberstatus', 'status', 'message', 'number', 'memberstatus', 'groupid', 'attachments', 'attachlist', 'imagelist'))),
			'ppp' => $_G['ppp'],
