...
$pdnovel['cover'] = '/<div class="book_img">.+?<img src="(.+?)"/i'; //小说封面采集规则
$pdnovel['coverfilter'] = 'http://www.uutxt.com/files.php?cover=/Images/NoImg.gif'; //过滤的封面图片
...
//----小说目录页面采集规则start
$pdnovel['chapterurl'] = 'http://chapter.uutxt.com/BookHtml/<{subnovelid}>/<{novelid}>/Index.shtml'; //小说目录页地址
...
//----章节内容页面采集规则start
$pdnovel['readurl'] = 'http://file-uu-cp.kakapan.com/<{subnovelid}>/<{novelid}>/<{chapterid}>.dec'; //章节阅读地址
$pdnovel['content'] = '/var nbtxt="(.*)";/is'; //章节内容采集规则
$pdnovel['contentfilter'] = '文字首发：www.3zcn.com';
//----章节内容页面采集规则end

//----页面列表格式start
$pdnovel['pageurl'] = 'http://www.uutxt.com/Book/showbooklist.aspx?tclassid=&nclassid=&page=<{pageid}>&orderbyid='; //列表页采集地址
