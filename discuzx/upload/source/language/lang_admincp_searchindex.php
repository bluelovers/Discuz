 ...
 *
 *      $Id: lang_admincp_searchindex.php 27449 2012-02-01 05:32:35Z zhangguosheng $
 *
...
$lang = array (
  ...
  array (
    ...
    array (
      0 => '站点广告 &raquo; 广告位',
      1 => 'adv_list_tip',
      2 => '您可以使用“自定义广告位”在页面的任意位置添加广告位。安装新的广告位，需将广告位脚本程序上传到 source/class/adv/ 目录，然后即可在以下列表中使用了。插件开发人员在设计新的广告位前请务必仔细阅读《Discuz! 技术文库》中的内容。',
    ),
  ),
  134 =>
  array (
...
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      ...
      12 => '推荐群组',
      13 => '填写要推荐到群组首页的群组 ID，以半角逗号 "," 隔开，最多显示 8 个，如不足会自动补充积分最高的群组。例：“23,56,983”',
...
',
  ...
  array (
    ...
    array (
      ...
      38 => '',
      39 => 'setting_home_base_default_view_profile',
      40 => '默认查看个人资料',
      41 => '该设置对管理员有效，开启后默认管理员查看将直接查看个人资料页面',
  ...
  array (
    ...
    array (
      ...
      36 => '通过邮件发送注册链接',
      37 => '开启后系统会发一条注册的地址到用户的邮箱，从该地址链接过来的允许注册，同时建议UCenter中开启一个邮箱只允许注册一个帐户',
  ...
  array (
    ...
    array (
      ...
      15 => '允许用户自由切换',
      16 => '设置是否允许用户自由切换宽窄风格',
      17 => 'setting_styles_global_jsmenu',
      18 => '论坛显示版块跳转菜单',
      19 => '注意: 当论坛分版块很多时，本功能会严重加重服务器负担',
      20 => 'setting_styles_global_allowfloatwin',
      21 => '启用浮动窗口',
      22 => '设置以浮动方式显示的窗口',
      23 => 'setting_styles_global_creditnotice',
      24 => '积分变动提示',
      25 => '当用户在站点的操作产生积分变动时，将弹出提示信息告知用户',
      26 => 'setting_styles_global_showusercard',
      27 => '显示用户名片',
      28 => '设置当鼠标移动到用户名位置上时是否显示他的名片',
  ...
  array (
    ...
    array (
      ...
      65 => 'setting_styles_viewthread_visitedthreads',
      66 => '显示最近访问帖子数量',
      67 => '设置在帖子浏览中显示的最近访问过的帖子数量，建议设置为 10 以内，0 为关闭此功能',
      68 => 'setting_styles_viewthread_author_onleft',
      69 => '作者用户名显示位置',
      70 => '显示位置并不会影响论坛的性能和美观，请根据您会员的浏览习惯进行选择',
      71 => 'setting_styles_viewthread_customauthorinfo',
      72 => '设置用户信息显示的位置',
    ),
  ),
  223 =>
  ...
  array (
    ...
    array (
      ...
      8 => '附件 URL 地址、媒体附件播放',
      9 => '开启附件 URL 地址后，上传附件的地址可通过 "attach://aid" 方式在任何帖内引用，并支持媒体类附件的直接播放，此项设置需要在 用户组 - 帖子相关 中允许用户组使用多媒体代码方可生效',
      10 => 'setting_attach_image_thumbstatus',
      11 => '论坛帖子附件缩略图设置',
      12 => '您可以设置自动为用户上传的 JPG/PNG/GIF 图片附件添加缩略图或将图片附件缩到指定的大小。不支持动画 GIF 格式',
      13 => 'setting_attach_image_thumbwidthheight',
      14 => '缩略图大小',
      15 => '设置缩略图的大小，小于此尺寸的图片附件将不生成缩略图',
      16 => 'setting_attach_basic_thumbsource',
      17 => '直接缩放原图',
      18 => '选择“是”，将直接缩放原图，而不生成缩略图文件',
      19 => 'setting_attach_image_thumbsourcewidthheight',
      20 => '原图缩放大小',
      21 => '设置原图的大小，所有大于此尺寸的图片附件将缩小到指定大小',
      22 => 'setting_attach_antileech_expire',
      23 => '附件链接有效期',
      24 => '单位：小时，0 或留空表示附件链接永久有效，过期后链接自动更新。本功能可有效防止附件被盗链或附件被软件批量下载，但是会给会员的正常下载带来不便',
      25 => 'setting_attach_antileech_refcheck',
      26 => '下载附件来路检查',
      27 => '选择“是”将检查下载附件的来路，来自其他网站或站点的下载请求将被禁止。注意: 本功能在开启“帖子中显示图片附件”时，会加重服务器负担',
    ),
  ),
  247 =>
  array (
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      2 => '启用内存优化功能将会大幅度提升程序性能和服务器的负载能力，内存优化功能需要服务器系统以及PHP扩展模块支持目前支持的内存优化接口有 Memcache、eAccelerator、Alternative PHP Cache(APC)、Xcache 四种，优化系统将会依据当前服务器环境依次选用接口内存接口的主要设置位于 config_global.php 当中，您可以通过编辑 config_global.php 进行高级设置',
