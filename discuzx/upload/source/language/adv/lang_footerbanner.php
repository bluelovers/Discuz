...
(
	...
	'footerbanner_desc' => '展現方式: 頁尾通欄廣告顯示於頁面下方，通常使用 960x60 或其他尺寸圖片、Flash 的形式。當前頁面有多個頁尾通欄廣告時，系統會隨機選取其中之一顯示。<br />價值分析: 與頁面頭部和中部相比，頁面尾部的展現機率相對較低，通常不會引起訪問者的反感，同時又基本能夠覆蓋\所有對廣告內容感興趣的受眾，因此適合中性而溫和的推廣。',
