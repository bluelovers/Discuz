...
document.writeln('<option value="0"' + google_default_0 + '>ºô­¶·j¯Á</option>');
document.writeln('<option value="1"' + google_default_1 + '>¯¸¤º·j¯Á</option>');
document.writeln('</select>');
document.writeln('&nbsp;<button type="submit" name="sa" value="true">·j¯Á</button>');
