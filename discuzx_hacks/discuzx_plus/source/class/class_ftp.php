...
class discuz_ftp
{
	 ...
	 * 上傳文件到ftp服務器
	 *
	 * @param sourcefile $source 原始文件(絕對地址)
	 * @param targetfile $target 目標文件(相對於ftp根的絕對地址)
	 * @return boolean
	 *
	 * @example 當上傳遇到錯誤, 請使用 $this->error() 查看錯誤代碼
	 */
