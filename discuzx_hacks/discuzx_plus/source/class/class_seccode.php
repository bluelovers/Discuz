...
class seccode {
	...
	var $code;			//note 100000-999999 範圍內隨機
	var $type 	= 0;		//note 0 英文圖片驗證碼  1 中文圖片驗證碼  2 Flash 驗證碼  3 語音驗證碼
	var $width 	= 150;		//note 寬度
	var $height 	= 60;		//note 高度
	var $background	= 1;		//note 隨機圖片背景
	var $adulterate	= 1;		//note 隨機背景圖形
	var $ttf 	= 0;		//note 隨機 TTF 字體
	var $angle 	= 0;		//note 隨機傾斜度(TTF)
	var $warping 	= 0;		//note 隨機扭曲(TTF)
	var $scatter	= 0;		//note 圖片打散
	var $color 	= 1;		//note 隨機顏色
	var $size 	= 0;		//note 隨機大小
	var $shadow 	= 1;		//note 文字陰影
	var $animator 	= 0;		//note /GIF 動畫
	var $fontpath	= '';		//note TTF 字庫目錄
	var $datapath	= '';		//note 圖片、聲音、Flash 等數據目錄
	var $includepath= '';		//note 其它包含文件目錄
...
$code = new seccode();
$code->code = $seccode;						//100000-999999 範圍內隨機
$code->type = $_G['setting']['seccodedata']['type'];                             //0 英文圖片驗證碼		相關數據目錄:/fonts/gif, /fonts/en
								//1 中文圖片驗證碼		相關數據目錄:/fonts/ch
								//2 Flash 驗證碼		相關數據目錄:/seccode/flash
								//3 語音驗證碼			相關數據目錄:/seccode/sound, /seccode/flash
$code->width = $_G['setting']['seccodedata']['width'];                           //寬度
$code->height = $_G['setting']['seccodedata']['height'];                         //高度
$code->background = $_G['setting']['seccodedata']['background'];                 //隨機圖片背景			相關數據目錄:/seccode/background
$code->adulterate = $_G['setting']['seccodedata']['adulterate'];                 //隨機背景圖形
$code->ttf = $_G['setting']['seccodedata']['ttf'];                               //隨機 TTF 字體			相關數據目錄:/fonts/en, /fonts/ch
$code->angle = $_G['setting']['seccodedata']['angle'];                           //隨機傾斜度
$code->color = $_G['setting']['seccodedata']['color'];                           //隨機顏色
$code->size = $_G['setting']['seccodedata']['size'];                             //隨機大小
$code->shadow = $_G['setting']['seccodedata']['shadow'];                         //文字陰影
$code->animator = $_G['setting']['seccodedata']['animator'];                     //GIF 動畫			相關Class:/include/gifmerge.class.php
$code->fontpath = DISCUZ_ROOT.'./static/image/seccode/font/';		//TTF 字庫目錄
$code->datapath = DISCUZ_ROOT.'./static/image/common/seccode/';		//圖片、聲音、Flash 等數據目錄
$code->includepath = DISCUZ_ROOT.'./include/';			//其它包含文件目錄
$code->display();
