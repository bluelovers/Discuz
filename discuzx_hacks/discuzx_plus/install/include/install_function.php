 ...
 *
 *      $Id: install_function.php 630 2010-09-10 06:43:14Z yexinhao $
 */
...
<div class="container">
	<div class="header">
		<h1>$title</h1>
		<span>Discuz! XPlus $version $install_lang $release</span>
EOT;
...
/**
	[UltraX] (C) 2001-$year Comsenz Inc.
...
/**
	...
	config_ucenter.php Build at $date
*/
...
function install_uc_server() {
	...
	$db->query("INSERT INTO {$uctablepre}applications SET name='Discuz! XPlus', url='$appurl', ip='$ucip', authkey='$appauthkey', synlogin='1', charset='$charset', dbcharset='$dbcharset', type='DISCUZX', recvnote='1', tagtemplates='$apptagtemplates'", $link);
