 ...
 *
 *      $Id: index.php 646 2010-09-13 03:37:40Z yexinhao $
 */
...
require ROOT_PATH.'./source/discuzxplus_version.php';
...
if($method == 'show_license') {
	...
	if($submit) {
		...
		$siteuniqueid = 'XPLUS'.$chars[date('y')%60].$chars[date('n')].$chars[date('j')].$chars[date('G')].$chars[date('i')].$chars[date('s')].substr(md5($onlineip.$timestamp), 0, 4).random(4);
