...
class seccode {
	...
	var $code;			//100000-999999 綎焚˦뺊	var $type 	= 0;		//0 Ӣ΄ͼƬѩ֤«  1 ֐΄ͼƬѩ֤«  2 Flash ѩ֤«  3 ӯҴѩ֤«
	var $width 	= 0;		//ﭶȊ	var $height 	= 0;		//蟶Ȋ	var $background	= 1;		//˦뺍솬᳾ʉvar $adulterate	= 1;		//˦뺱㾰ͼЎ
	var $ttf 	= 0;		//˦뺠TTF ז̥
	var $angle 	= 0;		//˦뺇㐱戊	var $color 	= 1;		//˦뺑Չ늉var $size 	= 0;		//˦뺴㐡
	var $shadow 	= 1;		//΄זҵӰ
	var $animator 	= 0;		//GIF 毻튉var $fontpath	= '';		//TTF ז
	var $datapath	= '';		//ͼƬᢉ鈷ᢆlash 刊���Ŀ¼
	var $includepath= '';		//Ƥ˼༺쎄쾄
