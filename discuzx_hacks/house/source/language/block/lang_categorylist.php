 ...
 *
 *      $Id: lang_categorylist.php 55 2010-09-15 05:41:47Z sunxianwei $
 */
...
(
	...
	'categorylist_keyword_comment' => '設置標題包含的關鍵字。注意: 留空為不進行任何過濾<br />關鍵字中可使用通配符 "*"<br />匹配多個關鍵字全部，可用空格或 "AND" 連接。如 win32 AND unix<br />匹配多個關鍵字其中部分，可用 "|" 或 "OR" 連接。如 win32 OR unix',
	...
	'categorylist_sorts' => '選擇分類',
	'categorylist_styles' => '分類顯示',
	'categorylist_area' => '地區',
	'categorylist_infoid' => '指定信息id',
	'categorylist_district' => '所在區',
	'categorylist_haspic' => '是否有圖',
	'categorylist_top' => '置頂主題',
	'categorylist_recommend_thread' => '推薦主題',
	'categorylist_any' => '不限',
	'categorylist_submit' => '提交',
	'categorylist_withpic_only' => '僅有圖片',
	'categorylist_top_only' => '僅置頂',
	'categorylist_digest_only' => '僅精華',
	'categorylist_all' => '全部',
	'categorylist_list' => '下拉列表',
	'categorylist_tab' => '標籤式',
	'categorylist_template_empty' => '沒有設置模板，請到後台設置模板',
);
