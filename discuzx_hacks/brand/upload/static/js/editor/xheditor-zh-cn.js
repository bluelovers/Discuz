...
var menuAlign=[{s:'左對齊',v:'justifyleft'},{s:'居中',v:'justifycenter'},{s:'右對齊',v:'justifyright'},{s:'兩端對齊',v:'justifyfull'}],menuList=[{s:'數字列表',v:'insertOrderedList'},{s:'符號列表',v:'insertUnorderedList'}];
...
if(enablealbum == 1) {
	var htmlImg = '<div style="width:550px; opacity:1; padding:5px 0;"><ul id="e_image_ctrl" class="imguptype" style="cursor: move;"><li><a onclick="switchImgbutton(\'www\');" id="e_btn_www" class="current" hidefocus="true" href="javascript:;">網絡圖片</a></li><li><a onclick="switchImgbutton(\'albumlist\');" id="e_btn_albumlist" hidefocus="true" href="javascript:;" class="">相冊圖片</a></li><li><a onclick="switchImgbutton(\'imgattachlist\');" id="e_btn_imgattachlist" hidefocus="true" href="javascript:;" class="">圖片列表</a></li><li><a onclick="switchImgbutton(\'multi\');" id="e_btn_multi" hidefocus="true" href="javascript:;" class="">批量上傳</a></li></ul><div id="e_cont"></div></div>';
} else {
	var htmlImg = '<div style="width:550px; opacity:1; padding:5px 0;"><ul id="e_image_ctrl" class="imguptype" style="cursor: move;"><li><a onclick="switchImgbutton(\'www\');" id="e_btn_www" class="current" hidefocus="true" href="javascript:;">網絡圖片</a></li></ul><div id="e_cont"></div></div>';
}
...
var arrTools={GStart:{},GEnd:{},Separator:{},Cut:{t:'剪切 (Ctrl+X)'},Copy:{t:'複製 (Ctrl+C)'},Paste:{t:'粘貼 (Ctrl+V)'},Pastetext:{t:'粘貼文本',h:isIE?0:1},Blocktag:{t:'段落標籤',h:1},Fontface:{t:'字體',h:1},FontSize:{t:'字體大小',h:1},Bold:{t:'加粗 (Ctrl+B)',s:'Ctrl+B'},Italic:{t:'斜體 (Ctrl+I)',s:'Ctrl+I'},Underline:{t:'下劃線 (Ctrl+U)',s:'Ctrl+U'},Strikethrough:{t:'刪除線 (Ctrl+S)',s:'Ctrl+S'},FontColor:{t:'字體顏色',h:1},BackColor:{t:'背景顏色',h:1},Removeformat:{t:'刪除文字格式'},Align:{t:'對齊',h:1},List:{t:'列表',h:1},Outdent:{t:'減少縮進 (Shift+Tab)',s:'Shift+Tab'},Indent:{t:'增加縮進 (Tab)',s:'Tab'},Link:{t:'超鏈接',h:1},Unlink:{t:'取消超鏈接'},Img:{t:'圖片',h:1},Flash:{t:'Flash動畫',h:1},Media:{t:'多媒體文件',h:1},Emot:{t:'表情',s:'ctrl+e',h:1},Table:{t:'表格',h:1},Source:{t:'源代碼'},Preview:{t:'預覽'},Fullscreen:{t:'全屏編輯 (Esc)',s:'Esc'},About:{t:'關於 xhEditor',h:1}};
var toolsThemes={
...
$.xheditor=function(textarea,options)
{
	...
	this.toggleSource=function(state)
	{
		...
		{//轉為編輯模式
			...
			if(isMozilla)
			{
				_this._exec("inserthtml","-");//修正firefox源代碼切換回來無法刪除文字的問題
	...
	this.toggleFullscreen=function(state)
	{
		...
		if(isMozilla)//臨時修正Firefox 3.6源代碼光標丟失問題
		{
	...
	this.showImg=function()
	{
		...
		$(function() { switchImgbutton('www');}); //編輯器上傳
	}
