 ...
 *
 *      $Id: tools.php 2280 2010-09-29 08:42:15Z songlixin $
 */
...
$toolspw = '1';   
/* 
   如果不需要在數據庫中設置，請修改上面一行單引號中的值為想要的密碼
   例如 $toolspw = 'QWESASDGy';  則在登陸的時候需要輸入的密碼為：QWESASDGy
*/
...
$menu = array(
		...
		//'convert' => toolslang('convert'),
		//'dbbak' => toolslang('dbbak'),
